...
GRLIB_civilians_amount = 5 						* GRLIB_civilian_activity;									// Civilian count multiplier.
GRLIB_cleanup_delay = 120;																						// Time in seconds until bodies of dead soldiers are cleaned up.
